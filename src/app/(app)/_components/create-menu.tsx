  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={setOpen}>
      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Popup className="fixed inset-x-0 bottom-0 z-50 mx-auto w-full max-w-md rounded-t-3xl bg-popover p-3 pb-[max(1.25rem,env(safe-area-inset-bottom))] shadow-lg ring-1 ring-foreground/10 duration-200 outline-none will-change-transform data-open:animate-in data-open:slide-in-from-bottom-4 data-closed:animate-out data-closed:slide-out-to-bottom-4">
