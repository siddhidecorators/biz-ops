    ...
    <>
      ...
      >
        ...
        <DialogPrimitive.Portal>
          ...
          <DialogPrimitive.Popup className="fixed inset-x-0 bottom-0 z-50 mx-auto flex max-h-[82vh] w-full max-w-md flex-col rounded-t-3xl bg-popover pb-[max(0.5rem,env(safe-area-inset-bottom))] shadow-xl ring-1 ring-foreground/10 duration-200 outline-none data-open:animate-in data-open:slide-in-from-bottom-6 data-closed:animate-out data-closed:slide-out-to-bottom-6">
