    ...
    <>
      ...
      >
        ...
        <DialogPrimitive.Portal>
          ...
          <DialogPrimitive.Popup className="fixed inset-x-0 bottom-0 z-50 mx-auto flex max-h-[82vh] w-full max-w-md flex-col rounded-t-3xl bg-popover pb-[max(0.5rem,env(safe-area-inset-bottom))] shadow-lg ring-1 ring-foreground/10 duration-300 ease-out outline-none will-change-transform data-open:animate-in data-open:fade-in-0 data-open:slide-in-from-bottom-6 data-closed:animate-out data-closed:fade-out-0 data-closed:slide-out-to-bottom-6">
